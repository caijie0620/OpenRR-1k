...
class NAFBlock(nn.Module):
    ...
    def forward(self, inp):
        ...
        # 从这波transformer应用到cv领域（带来LN替换BN），绝大部分的LN都是在C这个维度上的，如DETR，Swin，包括相关的ConvNeXt等工作。
...
class NAFNet(nn.Module):
    ...
    def __init__(self, img_channel=3,  width=16, output_channel=3, middle_blk_num=1, enc_blk_nums=[], dec_blk_nums=[]):
        super().__init__()
    ...
    def forward(self, inp, vgg_feature=None):
